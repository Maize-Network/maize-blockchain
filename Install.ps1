...
{
    Write-Output "Maize requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Maize blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/2WHH7yGaT9"
Write-Output ""
Write-Output "Try the Quick Start Guide to running maize-blockchain:"
Write-Output "https://github.com/Maize-Network/maize-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'maize init' to begin."
