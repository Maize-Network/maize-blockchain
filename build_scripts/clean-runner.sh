...
rm -rf ../venv || true
rm -rf venv || true
rm -rf maize_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf maize-blockchain-gui/build || true
rm -rf maize-blockchain-gui/daemon || true
rm -rf maize-blockchain-gui/node_modules || true
rm maize-blockchain-gui/temp.json || true
( cd "$PWD/maize-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
