...
Write-Output "   ---"
Write-Output "Get MAIZE_INSTALLER_VERSION"
# The environment variable MAIZE_INSTALLER_VERSION needs to be defined
$env:MAIZE_INSTALLER_VERSION = python .\build_scripts\installer-version.py -win
...
Write-Output "   ---"
Write-Output "Build maize-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install maize-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install maize-blockchain"
pip install --no-index --find-links=.\win_build\ maize-blockchain
...
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\maize-blockchain-gui\" -Recurse
...
electron-packager . Maize --asar.unpack="**\daemon\**" --overwrite --icon=.\src\assets\img\chia.ico --app-version=$packageVersion
Write-Output "   ---"
