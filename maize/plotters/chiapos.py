"""
NOTE: This contains duplicate code from `maize.cmds.plots`.
After `maize plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Maize Proof of Space", "version": chiapos_version, "installed": True}
