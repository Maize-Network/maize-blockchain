...
from maize.plot_sync.exceptions import (
...
from maize.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    ...
    def connection(self) -> WSMaizeConnection:
