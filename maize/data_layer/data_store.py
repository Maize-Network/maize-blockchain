...
from maize.data_layer.data_layer_errors import KeyNotFoundError, NodeHashError, TreeGenerationIncrementingError
...
class DataStore:
    ...
    async def _insert_root(
        ...
        # https://github.com/Chia-Network/maize-blockchain/pull/9284
