...
from maize.data_layer.dl_wallet_store import DataLayerStore
...
from maize.wallet.notification_manager import NotificationManager
...
class WalletStateManager:
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        xmz_spam_amount = self.config.get("xmz_spam_amount", 1000000)
        ...
        small_unspent_count = await self.coin_store.count_small_unspent(xmz_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < xmz_spam_amount
