...
from maize.protocols.protocol_state_machine import message_response_ok
from maize.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
...
from maize.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSMaizeConnection:
    """
