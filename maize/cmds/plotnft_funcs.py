...
from maize.pools.pool_config import load_pool_config, PoolWalletConfig, update_pool_config
...
from maize.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
...
from maize.cmds.cmds_util import transaction_submitted_msg, transaction_status_msg, get_any_service_client
...
async def create(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    if user_input.lower() == "y" or user_input.lower() == "yes":
        try:
            ...
            print(f"Error creating plot NFT: {e}\n    Please start both farmer and wallet with:  maize start -r farmer")
        return
    print("Aborting.")
