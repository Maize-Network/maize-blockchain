...
from maize.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(
            "Farmer public key (m/12381/8644/0/0):",
            master_sk_to_farmer_sk(sk).get_g1(),
        )
        print("Pool public key (m/12381/8644/1/0):", master_sk_to_pool_sk(sk).get_g1())
        print(
        ...
        if show_mnemonic:
            ...
            print(
                "First wallet secret key (m/12381/8644/2/0):",
