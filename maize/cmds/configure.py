...
from maize.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.maize.farm"
            testnet = "testnet7"
    ...
    if change_made:
        print("Restart any running maize services for changes to take effect")
