...
def supports_keyring_passphrase() -> bool:
    # Support can be disabled by setting MAIZE_PASSPHRASE_SUPPORT to 0/false
    return os.environ.get("MAIZE_PASSPHRASE_SUPPORT", "true").lower() in ["1", "true"]
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from maize.cmds.passphrase_funcs import prompt_for_passphrase
