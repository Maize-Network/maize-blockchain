...
from maize.protocols.wallet_protocol import PuzzleSolutionResponse, RejectHeaderBlocks, RejectHeaderRequest
...
from maize.util.api_decorators import api_request, peer_required, bytes_required, execute_task
...
class FullNodeAPI:
    ...
    @peer_required
    @api_request
    async def new_compact_vdf(self, request: full_node_protocol.NewCompactVDF, peer: ws.WSMaizeConnection):
        if self.full_node.sync_store.get_sync_mode():
            return None
