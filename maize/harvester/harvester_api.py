...
from maize.harvester.harvester import Harvester
from maize.plotting.util import PlotInfo, parse_plot_info
from maize.protocols import harvester_protocol
from maize.protocols.farmer_protocol import FarmingInfo
from maize.protocols.harvester_protocol import Plot, PlotSyncResponse
from maize.protocols.protocol_message_types import ProtocolMessageTypes
from maize.server.outbound_message import make_msg
...
from maize.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSMaizeConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSMaizeConnection
    ):
        """
