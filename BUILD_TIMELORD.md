...
required to run a [Timelord](https://github.com/Maize-Network/maize-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Maize-Network/maize-blockchain/blob/main/install-timelord.sh)
