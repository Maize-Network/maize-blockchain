...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@maize/core';
import {
...
import { mojo_to_maize_string } from '../../../util/maize';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_maize_string(props.balance)} TXMZ
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'maize_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'maize_addr://') {
