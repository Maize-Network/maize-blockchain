...
import { SyncingStatus, toBech32m } from '@maize/api';
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      throw new Error(t`Cannot send maize to coloured address. Please enter a maize address.`);
    }
    ...
    const feeValue = maizeToMojo(fee);
