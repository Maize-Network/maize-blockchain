...
This library provides support for TypeScript/JavaScript [Maize](https://www.maize.farm) apps to access the [Maize Blockchain RPC](https://github.com/Maize-Network/maize-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Maize Blockchain RPC.
...
```ts
import Client, { Wallet } from '@maize/api';
