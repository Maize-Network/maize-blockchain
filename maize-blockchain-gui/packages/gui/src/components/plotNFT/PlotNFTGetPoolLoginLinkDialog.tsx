...
import { Button, CopyToClipboard, Flex, Link, Loading } from '@maize/core';
import {
  Alert,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@maize/api-react';
import type { PlotNFT, PlotNFTExternal } from '@maize/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Maize-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
