...
import { OfferTradeRecord, toBech32m } from '@maize/api';
import {
  Button,
  Checkbox,
  Dialog,
...
const testnetDummyHost = 'offers-api-sim.maize.farm';
...
async function postToOfferBin(
  ...
  if (testnet) {
    return 'https://www.maize.farm/offers';
  }
...
const KeybaseTeamName = 'maize_offers';
