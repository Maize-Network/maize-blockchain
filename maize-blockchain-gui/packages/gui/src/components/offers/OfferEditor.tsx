...
import { useCreateOfferForIdsMutation } from '@maize/api-react';
...
import { maizeToMojo, catToMojo } from '@maize/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = maizeToMojo(formData.fee ?? 0);
