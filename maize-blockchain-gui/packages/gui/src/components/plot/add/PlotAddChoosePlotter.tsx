...
import { CardStep, Select, StateColor } from '@maize/core';
import { useGetPlottersQuery } from '@maize/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@maize/api';
import type { Plotter, PlotterMap } from '@maize/api';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Maize Proof of Space plotter. If unsure,
            use the default Maize Proof of Space plotter.
        </Trans>
      </Typography>
