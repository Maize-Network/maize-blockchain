      ...
      <DialogContent>
        ...
        {canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip
              title={t`Your passphrase can be stored in your system's secure credential store. Maize will be able to access your keys without prompting for your passphrase.`}
            >
