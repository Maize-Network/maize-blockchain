...
import { OfferSummaryRecord } from '@maize/api';
import { useTakeOfferMutation } from '@maize/api-react';
import {
  AlertDialog,
  maizeToMojo,
  useOpenDialog,
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? maizeToMojo(fee) : new BigNumber(0);
