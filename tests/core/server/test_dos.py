...
from maize.protocols.shared_protocol import Handshake
from maize.server.outbound_message import make_msg, Message
...
class TestDos:
    ...
    async def test_large_message_disconnect_and_ban(self, setup_two_nodes_fixture, self_hostname):
        ...
        ssl_context = ssl_context_for_client(
            server_2.maize_ca_crt_path, server_2.maize_ca_key_path, server_2.p2p_crt_path, server_2.p2p_key_path
        )
    ...
    async def test_spam_tx(self, setup_two_nodes_fixture, self_hostname):
        ...
        ws_con: WSMaizeConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSMaizeConnection = list(server_2.all_connections.values())[0]
