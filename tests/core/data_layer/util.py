...
from maize.data_layer.data_layer_util import NodeType, Side, Status
...
class MaizeRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["MAIZE_ROOT"] = os.fspath(self.path)
        kwargs["env"]["MAIZE_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("maize"),
            "--root-path",
            self.path,
            *args,
        ]
