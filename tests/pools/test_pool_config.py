...
from maize.pools.pool_config import PoolWalletConfig
from maize.util.config import create_default_maize_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_maize_config(test_root, ["config.yaml"])
