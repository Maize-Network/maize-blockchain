...
from maize.wallet.puzzles import p2_conditions, p2_delegated_puzzle_or_hidden_puzzle
...
from maize.clvm.spend_sim import SpendSim, SimClient

"""
This test suite aims to test:
    - maize.wallet.puzzles.singleton_top_layer.py
    - maize.wallet.puzzles.singleton_top_layer.clvm
    - maize.wallet.puzzles.singleton_top_layer_v1_1.py
...
class TestSingleton:
    ...
    async def test_singleton_top_layer(self, version):
        try:
            ...
            if version == 0:
                from maize.wallet.puzzles import singleton_top_layer

                adapted_puzzle: Program = singleton_top_layer.adapt_inner_to_singleton(starting_puzzle)  # noqa
            else:
                from maize.wallet.puzzles import singleton_top_layer_v1_1 as singleton_top_layer
