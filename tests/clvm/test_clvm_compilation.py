...
wallet_program_files = set(
    [
        "maize/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "maize/wallet/puzzles/cat_v2.clvm",
        "maize/wallet/puzzles/chialisp_deserialisation.clvm",
        "maize/wallet/puzzles/rom_bootstrap_generator.clvm",
        "maize/wallet/puzzles/generator_for_single_coin.clvm",
        "maize/wallet/puzzles/lock.inner.puzzle.clvm",
        "maize/wallet/puzzles/p2_conditions.clvm",
        "maize/wallet/puzzles/p2_delegated_conditions.clvm",
        "maize/wallet/puzzles/p2_delegated_puzzle.clvm",
        "maize/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "maize/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "maize/wallet/puzzles/p2_puzzle_hash.clvm",
        "maize/wallet/puzzles/rl_aggregation.clvm",
        "maize/wallet/puzzles/rl.clvm",
        "maize/wallet/puzzles/sha256tree_module.clvm",
        "maize/wallet/puzzles/singleton_top_layer.clvm",
        "maize/wallet/puzzles/did_innerpuz.clvm",
        "maize/wallet/puzzles/decompress_puzzle.clvm",
        "maize/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "maize/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "maize/wallet/puzzles/block_program_zero.clvm",
        "maize/wallet/puzzles/test_generator_deserialize.clvm",
        "maize/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "maize/wallet/puzzles/p2_singleton.clvm",
        "maize/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "maize/wallet/puzzles/pool_member_innerpuz.clvm",
        "maize/wallet/puzzles/singleton_launcher.clvm",
        "maize/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
        "maize/wallet/puzzles/genesis_by_puzzle_hash.clvm",
        "maize/wallet/puzzles/everything_with_signature.clvm",
        "maize/wallet/puzzles/delegated_tail.clvm",
        "maize/wallet/puzzles/settlement_payments.clvm",
        "maize/wallet/puzzles/genesis_by_coin_id.clvm",
        "maize/wallet/puzzles/singleton_top_layer_v1_1.clvm",
        "maize/wallet/puzzles/nft_metadata_updater_default.clvm",
        "maize/wallet/puzzles/nft_metadata_updater_updateable.clvm",
        "maize/wallet/puzzles/nft_state_layer.clvm",
        "maize/wallet/puzzles/nft_ownership_layer.clvm",
        "maize/wallet/puzzles/nft_ownership_transfer_program_one_way_claim_with_royalties.clvm",
        "maize/wallet/puzzles/decompress_block_spends.clvm",
    ]
)

clvm_include_files = set(
    ["maize/wallet/puzzles/create-lock-puzzlehash.clvm", "maize/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "maize/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to maize/wallet/puzzles, but not added to `wallet_program_files`
        """
